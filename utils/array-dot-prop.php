...
class array_dot_prop implements ArrayAccess, Countable, IteratorAggregate, JsonSerializable
{
    /**
     * The stored items
     *
    ...
    protected $delimiter = ".";
    /**
        Can be used to create instance of class. 
        @class-document-advanced
    */
    ...
    */
    ...
    /**
        Merges a path with an external array. 
    */
    public function wp_parse_args( string $key, array $with ){
        $this->set( $key, wp_parse_args(
            $this->get( $key, [] ), 
            $with
        ) );
    }
