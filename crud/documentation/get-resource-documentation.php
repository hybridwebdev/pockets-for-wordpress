...
class get_resource_documentation extends get_class_documentation {
        ...
        ob_start(); ?>
            <div class='grid columns-1 gap-2'>
                <p>
                    ...
                    <class-document-link class='fw-8 text-primary-lt' link='<?php echo $class_info['name'] // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped?>|method|request_using_array'>request_using_array</class-document-link> 
                ...
                <p>
                    ...
                    <class-document-link class='fw-8 text-primary-lt' link='<?php echo $class_info['name'] // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>|property|default_array_by'>
                        default_array_by
                    </class-document-link> property of this class. For example:
                </p>
                <pockets-ux-code-block language='PHP' code='<?php echo $by_example // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped?>'/>
                <p>
    ...
    function template_request_using_method(array $method) : string {
        ...
        ob_start(); ?>
            <div class='grid columns-1 gap-2'>
                <p>
                    This method handles setting up the resource for this crud model. It handles requests of type <code><?php echo $type // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped?></code>.
                </p>
                <p>
                    See <class-document-link class='fw-8 text-primary-lt' link='<?php echo $this->data['info']['name'] // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped?>|class'>class info</class-document-link>  for more information.
                </p>
            </div>
        <?php return ob_get_clean(); 
    }
        ...
        ob_start(); ?>
            <div class='grid columns-1 gap-2'>
                <p>
                    ...
                    It handles requests when the type of argument is an <code>array</code> and a <code>by</code> parameter of <code><?php echo $type // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped?></code> is provided.
                </p>
                <pockets-ux-code-block language='PHP' code='<?php echo $by_example // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped?>'/>
                <p>
                    See <class-document-link class='fw-8 text-primary-lt' link='<?php echo $this->data['info']['name'] // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped?>|class'>class info</class-document-link>  for more information.
        ...
        ob_start(); ?>
            <div class='grid columns-1 gap-2'>
                <p>
                    ...
                    <class-document-link class='fw-8 text-primary-lt' link='<?php echo $this->data['info']['name'] // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped?>|method|request_using_array'>request_using_array</class-document-link> 
