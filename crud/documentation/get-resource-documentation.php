...
class get_resource_documentation extends get_class_documentation {
        ...
        ob_start(); ?>
            <div class='grid columns-1 gap-2'>
                <p>
                    ...
                    <class-document-link 
                        class='fw-8 text-primary-lt' 
                        link='<?php echo esc_attr($class_info['name']) ?>|method|request_using_array'
                    >
                        request_using_array
                    </class-document-link> 
                ...
                <p>
                    ...
                    <class-document-link 
                        class='fw-8 text-primary-lt' 
                        link='<?php echo esc_attr($class_info['name'])?>|property|default_array_by'
                    >
                        default_array_by
                    </class-document-link> property of this class. For example:
                </p>
                <pockets-ux-code-block language='PHP' code='<?php echo $by_example // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- sanitized earlier ?>'/>
                <p>
        ...
        ob_start(); ?>
            <div class='grid columns-1 gap-2'>
                ...
                <p>
                    ...
                    <class-document-link 
                        class='fw-8 text-primary-lt' 
                        link='<?php echo esc_attr($this->data['info']['name']) ?>|class'
                    >class info</class-document-link>  for more information.
                </p>
            </div>
        <?php return ob_get_clean(); 
    }
    ...
    function template_array_by_method(array $method) : string {
        ...
        $type = esc_html( str_replace( "array_by_", '', $method['name'] ) ); 
        ...
        ob_start(); ?>
            <div class='grid columns-1 gap-2'>
                <p>
                    ...
                    It handles requests when the type of argument is an <code>array</code> and a <code>by</code> parameter of <code><?php echo $type // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- sanitized earlier ?></code> is provided.
                </p>
                <pockets-ux-code-block language='PHP' code='<?php echo $by_example // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- sanitized earlier ?>'/>
                <p>
                    See 
                    ...
                    >
                        class info
                    </class-document-link>  for more information.
                </p>
            </div>
        <?php return ob_get_clean();
    }
        ...
        ob_start(); ?>
            <div class='grid columns-1 gap-2'>
                <p>
                    ...
                    <class-document-link 
                        class='fw-8 text-primary-lt' 
                        link='<?php echo esc_attr($this->data['info']['name'])?>|method|request_using_array'
                    >
                        request_using_array
                    </class-document-link> 
